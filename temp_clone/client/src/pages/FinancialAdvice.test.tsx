...
jest.mock("@tanstack/react-query", () => ({
  ...
  useMutation: jest.fn().mockReturnValue({
    ...
    data: {
      ...
      summary:
        "Your financial situation looks good, but improvements can be made.",
      provider: "openai",
    },
  }),
...
describe("FinancialAdvice Component", () => {
  ...
  it("displays form and allows question input", () => {
    ...
    fireEvent.change(textarea, {
      target: { value: "How can I save more money?" },
    });
  ...
  it("submits question and generates advice", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/You should save more for your emergency fund./i),
      ).toBeInTheDocument();
    });
  });
