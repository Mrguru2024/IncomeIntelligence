...
export default function IncomeBreakdown() {
  ...
  const formAmount = formContext
    ? useWatch({ control: formContext.control, name: "amount" })
    : "0";
  ...
  const chartData =
    breakdown.needs > 0 || breakdown.investments > 0 || breakdown.savings > 0
      ? [
          ...
          {
            name: `Investments (${investmentsPercentage}%)`,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            <div className="bg-blue-50 rounded-lg p-3 sm:p-4">
              <div className="flex items-center justify-between mb-1 sm:mb-2">
                ...
                <span className="bg-primary text-white text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">
                  {needsPercentage}%
                </span>
              </div>
            ...
            <div className="bg-purple-50 rounded-lg p-3 sm:p-4">
              <div className="flex items-center justify-between mb-1 sm:mb-2">
                ...
                <span className="bg-purple-600 text-white text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">
                  {investmentsPercentage}%
                </span>
              </div>
              <div className="text-base sm:text-xl font-semibold text-gray-800">
            ...
            <div className="bg-green-50 rounded-lg p-3 sm:p-4">
              <div className="flex items-center justify-between mb-1 sm:mb-2">
                ...
                <span className="bg-green-600 text-white text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">
                  {savingsPercentage}%
                </span>
              </div>
              <div className="text-base sm:text-xl font-semibold text-gray-800">
