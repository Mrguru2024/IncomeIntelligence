...
function createHeroSection() {
  ...
  heroSection.style.backgroundImage =
    "linear-gradient(135deg, rgba(255,255,255,0.8) 0%, rgba(240,249,240,0.8) 100%)";
  ...
  contentContainer.style.textAlign =
  ...
  subheadline.textContent =
    "The smart financial platform built for service providers and gig workers to track income, maximize earnings, and build wealth through the proven 40/30/30 method.";
  ...
  ctaContainer.style.justifyContent =
  ...
  tagsContainer.style.justifyContent =
    window.innerWidth <= 960 ? "center" : "flex-start";
  ...
  heroImage.style.boxShadow =
    "0 10px 30px rgba(0, 0, 0, 0.1), 0 1px 5px rgba(0, 0, 0, 0.05)";
  ...
  ["#00C6A7", "#233D4D", "#F4A300"].forEach((color, index) => {
    // Mint Green, Deep Sapphire Blue, Sunstone Gold
  ...
  notificationText1.innerHTML =
    '<strong>New Income!</strong><br><span style="font-size: 0.85rem; color: #777;">$125.00 from Gig Work</span>';
  ...
  if (window.innerWidth > 768) {
    ...
    notificationText2.innerHTML =
      '<strong>Goal Reached!</strong><br><span style="font-size: 0.85rem; color: #777;">Savings: $1,000</span>';
...
function createFeaturesSection() {
  ...
  subheading.textContent =
    "Stackzen gives you all the tools you need to track, manage, and grow your income while building wealth through the proven 40/30/30 method.";
  ...
  featuresGrid.style.gridTemplateColumns =
  ...
  const features = [
    {
      ...
      description:
        "Easily log and categorize all your income sources in one place. Get a clear picture of how much you're earning and where it's coming from.",
    },
    {
      icon: "📊",
      title: "40/30/30 Split",
      description:
        "Automatically split your income using the proven 40/30/30 method: 40% for needs, 30% for investments, and 30% for savings.",
    },
    {
      icon: "🏦",
      title: "Bank Connection",
      description:
        "Securely connect your bank accounts to automatically import transactions and keep your financial data up to date.",
    },
    {
      icon: "🎯",
      title: "Goal Setting",
      description:
        "Set financial goals and track your progress. Visualize your journey and stay motivated to achieve your targets.",
    },
    {
      icon: "💼",
      title: "Gig Opportunities",
      description:
        "Discover new income opportunities through our curated marketplace of gigs and side hustles for service providers.",
    },
    {
      icon: "🔄",
      title: "Affiliate Program",
      description:
        "Earn extra income by referring others to products and services that can help them grow their own business.",
    },
  ];
...
function createIncomeSplitSection() {
  ...
  description.textContent =
    "The 40/30/30 method is a simple but powerful approach to managing your income. It helps you allocate your earnings in a balanced way to cover your needs while building wealth through investments and savings.";
  ...
  const splits = [
    {
      ...
      description:
        "Cover your essential expenses like rent, utilities, groceries, and basic transportation.",
      icon: "🏠",
    },
    {
      ...
      description:
        "Grow your wealth through stocks, bonds, real estate, or your own business ventures.",
      icon: "📈",
    },
    {
      ...
      description:
        "Build an emergency fund, save for major purchases, or set aside money for future goals.",
      icon: "💰",
    },
  ];
  ...
  splits.forEach((split) => {
    ...
    iconContainer.style.marginBottom =
      window.innerWidth <= 480 ? "0.5rem" : "0";
  ...
  customNote.innerHTML =
    "<strong>Pro Tip:</strong> You can customize these percentages in Stackr to match your unique financial situation and goals.";
...
function createTestimonialsSection() {
  ...
  const subheading = document.createElement("p");
  subheading.textContent =
    "Hear from other service providers who have transformed their financial future with Stackzen.";
  subheading.style.fontSize = "1.1rem";
  subheading.style.lineHeight = "1.6";
  subheading.style.color = "#555";
  ...
  testimonialsContainer.style.gridTemplateColumns =
    window.innerWidth <= 768
      ? "1fr"
  ...
  const testimonials = [
    {
      quote:
        "Since I started using the 40/30/30 method with Stackzen, I've saved over $5,000 in just 6 months. It's completely changed how I think about my freelance income.",
      name: "Michael T.",
    ...
    {
      quote:
        "As a hair stylist, my income used to be unpredictable. Stackzen helped me organize my finances and start investing for the first time. Now I'm building wealth while doing what I love.",
      name: "Jessica K.",
    ...
    {
      quote:
        "I was living paycheck to paycheck before Stackzen. Their income tools helped me find new gig opportunities and increase my monthly earnings by 35%. Game changer!",
      name: "David L.",
...
function createIncomeOpportunitiesSection() {
  ...
  const description = document.createElement("p");
  description.textContent =
    "Stackzen doesn't just help you manage your income — it helps you increase it. Discover new income streams designed specifically for service providers.";
  description.style.fontSize = "1.1rem";
  description.style.lineHeight = "1.6";
  description.style.color = "#555";
  description.style.marginBottom = "2rem";
  ...
  const opportunities = [
    {
      title: "Stackzen Gigs",
      description:
        "Access our curated marketplace of gigs and side hustles specifically for service providers.",
      icon: "👔",
      color: "#00C6A7", // Mint Green
    },
    {
      ...
      description:
        "Earn commissions by promoting products and services that help you and others grow.",
      icon: "🔗",
      color: "#233D4D", // Deep Sapphire Blue
    },
    {
      ...
      description:
        "Complete simple tasks and challenges to earn extra cash while building good financial habits.",
      icon: "🎯",
      color: "#F4A300", // Sunstone Gold
    },
  ];
  ...
  opportunities.forEach((opportunity) => {
    ...
    textContainer.style.textAlign =
      window.innerWidth <= 480 ? "center" : "left";
  ...
  comingSoonTag.innerHTML =
    '🔥 Coming Soon: <span style="color: #4CAF50;">Invoice Builder</span> and <span style="color: #2196F3;">Creative Grants</span>';
  ...
  ["$3000", "$2500", "$2000", "$1500", "$1000", "$500", "$0"].forEach(
    (label) => {
      const labelEl = document.createElement("div");
  ...
  baseIncomeGraph.style.background =
    "linear-gradient(to top, rgba(35, 61, 77, 0.2) 0%, rgba(35, 61, 77, 0) 100%)"; // Deep Sapphire Blue with transparency
  baseIncomeGraph.style.borderTopLeftRadius = "4px";
  baseIncomeGraph.style.borderTopRightRadius = "4px";
  baseIncomeGraph.style.clipPath =
    "polygon(0% 100%, 0% 20%, 20% 30%, 40% 25%, 60% 40%, 80% 35%, 100% 30%, 100% 100%)";
  ...
  baseIncomeLine.style.clipPath =
    "polygon(0% 20%, 20% 30%, 40% 25%, 60% 40%, 80% 35%, 100% 30%)";
...
function createPricingSection() {
  ...
  const subheading = document.createElement("p");
  subheading.textContent =
    "Start with our free plan and upgrade as your financial needs grow. No hidden fees, no commitments.";
  subheading.style.fontSize = "1.1rem";
  subheading.style.lineHeight = "1.6";
  subheading.style.color = "#555";
  ...
  plansContainer.style.flexDirection =
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "9",
      description:
        "For service providers looking to grow their income and wealth.",
      isPopular: true,
      features: [
        "✅ Everything in Free",
        "✅ Bank connections",
  ...
  plans.forEach((plan) => {
    ...
    planCard.style.border = plan.isPopular
      ? "2px solid #00C6A7"
      : "1px solid #e0e0e0"; // Mint Green for popular plan
  ...
  guaranteeText.innerHTML =
    "<strong>30-Day Money-Back Guarantee</strong><br>Try Stackzen Pro risk-free. If you're not satisfied within 30 days, we'll refund your payment.";
...
function createFAQSection() {
  ...
  faqContainer.style.gridTemplateColumns =
  ...
  const faqs = [
    {
      ...
      answer:
        "The 40/30/30 method is a financial strategy that allocates 40% of your income to needs (essentials like rent and food), 30% to investments (stocks, bonds, real estate, business), and 30% to savings (emergency fund, future purchases, goals). It's a balanced approach to managing your money while building wealth.",
    },
    {
      question: "How does Stackzen help me make more money?",
      answer:
        "Stackzen provides tools like Stackzen Gigs (curated job opportunities), Affiliate Program Hub (earn commissions through referrals), and daily money challenges. These tools are designed specifically for service providers to help you discover and capitalize on new income streams.",
    },
    {
      question: "Do I need a bank account to use Stackzen?",
      answer:
        "No, you can use Stackzen without connecting a bank account. You can manually track your income and use the 40/30/30 method. However, connecting your bank makes the experience more powerful with automatic transaction imports and real-time balance updates.",
    },
    {
      question: "Is my financial data secure?",
      answer:
        "Yes, we take security seriously. We use bank-level encryption to secure your data, and we never store your banking credentials. Our secure Plaid integration means your login information is never seen or stored by Stackzen.",
    },
    {
      question: "What's the difference between Pro and Free plans?",
      answer:
        "The Free plan gives you basic income tracking and the 40/30/30 split visualization. The Stackzen Pro plan adds bank connections, automatic transaction imports, income opportunities, advanced analytics, priority support, and customizable split ratios.",
    },
    {
      question: "Can I customize the 40/30/30 split?",
      answer:
        "Yes! With Stackzen Pro, you can customize the split percentages to match your financial situation and goals. Whether you want a 50/30/20 split or something completely different, Stackzen adapts to your needs.",
    },
  ];
...
function createCTASection() {
  ...
  section.style.backgroundImage =
    "linear-gradient(135deg, #233D4D 0%, #1B1B1E 100%)"; // Deep Sapphire Blue to Matte Charcoal
  ...
  const subheading = document.createElement("p");
  subheading.textContent =
    "Join thousands of service providers who are using Stackzen to track, grow, and optimize their income with the 40/30/30 method.";
...
function createFooter() {
  ...
  footerNav.style.justifyContent =
    window.innerWidth <= 768 ? "space-between" : "space-around";
  ...
  bottomFooter.style.flexDirection =
    window.innerWidth <= 768 ? "column" : "row";
  bottomFooter.style.justifyContent = "space-between";
  bottomFooter.style.alignItems =
