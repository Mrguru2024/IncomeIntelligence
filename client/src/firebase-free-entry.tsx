// This file serves as the entry point for our firebase-free implementation
// It's designed to be built separately from the main application
...
// Add getAuthContext to window object
declare global {
  interface Window {
...
window.getAuthContext = () => {
  const context = useContext(AuthContext);
  if (context === undefined) {
    throw new Error('getAuthContext called outside of AuthProvider');
  }
  return context;
};
...
// Print a diagnostic message before starting
console.log('Firebase-free entry point loaded');
...
if (rootElement) {
  ...
  console.log('Firebase-free app rendered successfully');
} else {
