...
import { Expense, expenseCategories, getExpenseCategoryById } from "@shared/schema";
import {
  Card,
  CardContent,
            ...
            <Card key={expense.id} className="overflow-hidden">
              <CardContent className="p-0">
                <div className="flex items-start p-4">
                  <div className={`p-2 rounded-full bg-${category.color}-100 flex-shrink-0 mr-4`}>
                    <svg
                    ...
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-500 mt-1">
                          {format(date, "MMM d, yyyy")} · {expense.paymentMethod}
