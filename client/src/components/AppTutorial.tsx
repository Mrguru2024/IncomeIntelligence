...
const tutorialSections: TutorialSections = {
  dashboard: [
    {
      ...
      description: 'This is your financial command center where you can see an overview of your finances at a glance.',
      highlightSelector: '.dashboard-header',
    },
    {
      title: 'Income Allocation',
      description: 'See how your income is allocated into the 40/30/30 split for Needs, Investments, and Savings.',
  ...
  expenses: [
    {
      ...
      description: 'Monitor and categorize your expenses to better understand your spending patterns.',
    ...
    },
    {
      ...
      description: 'View your expenses organized by category to identify spending patterns.',
  ...
  goals: [
    ...
    },
    {
      ...
      description: 'See your progress towards each goal and adjust contributions as needed.',
  ...
  settings: [
    ...
    },
    {
      ...
      description: 'Adjust your default income allocation ratios to better match your financial strategy.',
      highlightSelector: '.allocation-settings',
    },
    {
      title: 'Notification Preferences',
      description: 'Manage how and when you receive notifications and reminders.',
...
const AppTutorial = () => {
  ...
  const [isTutorialCompleted, setIsTutorialCompleted] = useLocalStorage('stackr-tutorial-completed', false);
  const [completedSections, setCompletedSections] = useLocalStorage<string[]>('stackr-completed-tutorials', []);
  ...
  useEffect(() => {
    ...
    if (!isTutorialCompleted && !completedSections.includes(pagePath) && tutorialSections[pagePath]) {
  ...
  const handleComplete = () => {
    ...
    const allCompleted = allSections.every(section => updatedCompleted.includes(section));
          ...
          <div className="px-6 py-4">
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Step {currentStepIndex + 1} of {currentSteps.length}</span>
