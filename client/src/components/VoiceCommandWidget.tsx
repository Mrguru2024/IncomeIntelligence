  ...
  const toggleListening = () => {
    if (isListening) {
      ...
      if (transcript) {
        ...
        if (command.includes('show income') || command.includes('income history')) {
        ...
        } else if (command.includes('show dashboard') || command.includes('go home')) {
          setLocation('/');
        ...
        } else if (command.includes('show bank') || command.includes('bank connections')) {
        ...
        } else if (command.includes('voice assistant') || command.includes('voice commands')) {
