    ...
    <Card className="w-full max-w-md mx-auto">
        ...
        {user.twoFactorEnabled ? (
          <>
            <p className="text-sm mb-4">
              Two-factor authentication is currently <span className="font-bold text-green-600">enabled</span> for your account.
            </p>
            ...
            {showBackupCodes ? (
              <>
                ...
                {isBackupCodesLoading ? (
                  ...
                  <p>No backup codes available. Try disabling and re-enabling 2FA.</p>
                )}
              </>
            ) : (
              <Button 
            ...
            <form onSubmit={handleDisable}>
              <div className="space-y-2">
                <Label htmlFor="password">Enter your password to disable 2FA</Label>
                <Input
                  id="password"
                  type="password"
                  value={password}
      ...
      <CardFooter className="flex flex-col">
        <p className="text-xs text-slate-500 text-center">
          ...
          when you sign in, in addition to your password.
        </p>
      </CardFooter>
    </Card>
  );
