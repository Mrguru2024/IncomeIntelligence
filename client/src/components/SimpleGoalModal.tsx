...
export default function SimpleGoalModal({
  isOpen,
  onClose,
}: SimpleGoalModalProps) {
  ...
  const handleAskAi = async () => {
    ...
    if (!aiQuestion) {
      toast({
        ...
        description:
          "Enter a question about financial goals to get AI suggestions",
        variant: "destructive",
      });
      return;
    }
  ...
  async function onSubmit(data: GoalFormValues) {
    try {
      ...
      formattedData.userId = 1; // Default user ID
  ...
  return (
    <CustomModal isOpen={isOpen} onClose={onClose} title="Create New Goal">
      <p className="text-sm text-gray-500 mb-6">
        Set a new financial goal to track your progress towards financial
        milestones.
      </p>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Ask for advice on setting realistic and effective financial
                  goals
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) =>
                        form.setValue("aiQuestion", e.target.value)
                      }
                    />
