    ...
    <div className="container mx-auto py-12 px-4">
      <div className="text-center space-y-4 max-w-3xl mx-auto mb-12">
        ...
        <div className="flex items-center justify-center mt-8 space-x-4">
          <span
            className={!annualBilling ? "font-medium" : "text-muted-foreground"}
          >
            Monthly
          </span>
          <Switch
          ...
          <div className="flex items-center">
            ...
            <Badge
              variant="outline"
              className="ml-2 bg-green-50 text-green-700 dark:bg-green-950 dark:text-green-400 border-green-200 dark:border-green-800"
            >
              Save 26%
            </Badge>
          </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <ul className="space-y-2.5">
              {freeFeatures.map((feature, i) => (
                <li key={i} className="flex items-start">
                  <Check
                    size={18}
                    className="text-green-500 shrink-0 mt-0.5 mr-2"
                  />
                  <span>{feature}</span>
                </li>
              ))}
        ...
        <Card className="border-primary relative md:scale-105 shadow-md">
          <div className="absolute top-0 right-0 transform translate-x-2 -translate-y-2">
            <Badge className="bg-primary hover:bg-primary-focus">
              Most Popular
            </Badge>
          </div>
          <CardHeader>
            ...
            <div className="mt-2">
              <span className="text-3xl font-bold">
                ${annualBilling ? (annualPrice / 12).toFixed(2) : monthlyPrice}
              </span>
            ...
            <ul className="space-y-2.5">
              {lifetimeFeatures.map((feature, i) => (
                <li key={i} className="flex items-start">
                  <Star
                    size={18}
                    className="text-amber-500 shrink-0 mt-0.5 mr-2"
                  />
                  <span>{feature}</span>
                </li>
              ))}
          ...
          <CardFooter className="flex flex-col space-y-2">
            {!user ? (
              <Button
                ...
                className="w-full"
                onClick={() =>
                  setLocation("/auth?redirect=/subscribe?plan=lifetime")
                }
              >
                Get Lifetime Access
              </Button>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              The free tier includes the core functionality of Stackr: manual
              40/30/30 income splits, basic budget tracking, transaction logs,
              and access to the marketplace. It's perfect for getting started
              and testing the app.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Yes! You can upgrade from Free to Pro, or from Pro to Lifetime at
              any time. You can also downgrade from Pro to Free at the end of
              your billing cycle. Lifetime access never expires.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Absolutely. We use Stripe for payment processing, which maintains
              the highest level of security standards. We never store your
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              We offer a 14-day money-back guarantee for Pro subscriptions. If
              you're not satisfied with Stackr Pro, contact us within 14 days of
              your purchase for a full refund. Lifetime purchases are
