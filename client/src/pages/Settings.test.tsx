...
jest.mock("../../components/ui/card", () => {
  ...
  return {
    ...
    CardDescription: function CardDescription({
      children,
    }: {
      children: React.ReactNode;
    }) {
...
jest.mock("../../components/ui/radio-group", () => {
  ...
  return {
    ...
    RadioGroupItem: function RadioGroupItem({
      value,
      id,
    }: {
      value: string;
...
describe("Settings Component", () => {
  ...
  it("handles AI settings changes correctly", async () => {
    ...
    // Update max retries
    fireEvent.change(screen.getByTestId("input-max-retries"), {
      target: { value: "5" },
    });
  ...
  it("updates and saves split ratio changes", async () => {
    const { updatePercentages } = jest
      .requireMock("../../hooks/useIncomeStore")
      .useIncomeStore();
