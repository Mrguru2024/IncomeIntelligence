...
const securityTips = [
  {
    ...
    description:
      "Create a password that is at least 12 characters long with a mix of uppercase, lowercase, numbers, and symbols.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Be wary of suspicious emails or messages asking for your credentials or personal information.",
  },
];
      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your account's security settings and two-factor
            authentication.
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Your account is currently only protected by a password.
