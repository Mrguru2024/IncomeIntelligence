...
type OnboardingStep = 'welcome' | 'personality' | 'profile' | 'income' | 'goals' | 'tutorial' | 'complete';
...
export default function OnboardingPage() {
  ...
  const updateOnboardingStatus = useMutation<any, Error, { onboardingStep: string; onboardingCompleted?: boolean }>({
    mutationFn: async (data) => {
      if (!user?.id) throw new Error('User ID not available');
      const res = await apiRequest('PATCH', `/api/users/${user.id}/onboarding`, data);
  ...
  useEffect(() => {
    if (userData?.onboardingCompleted) {
      navigate('/');
    } else if (userData?.onboardingStep && userData.onboardingStep !== 'welcome') {
  ...
  useEffect(() => {
    const steps: OnboardingStep[] = ['welcome', 'personality', 'profile', 'income', 'goals', 'tutorial', 'complete'];
    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <Card className="w-full">
        {currentStep === 'welcome' && (
          <>
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl">Welcome to Stackr</CardTitle>
              <CardDescription>
                Let's set up your account to make the most of your financial journey.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg">
                <p className="text-sm">This should take about 5-7 minutes to complete. Your data helps us provide you with personalized recommendations and insights.</p>
              </div>
            </CardContent>
        ...
        {currentStep === 'personality' && (
          <>
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl">Discover Your Spending Personality</CardTitle>
              <CardDescription>
        ...
        {currentStep === 'profile' && (
          <>
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl">Professional Profile</CardTitle>
              <CardDescription>
                Tell us about your business and professional details.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-center py-20">Profile Form Component Will Go Here</p>
        ...
        {currentStep === 'income' && (
          <>
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl">Income Allocation</CardTitle>
              <CardDescription>
                Configure how your income should be distributed.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-center py-20">Income Allocation Form Component Will Go Here</p>
        ...
        {currentStep === 'goals' && (
          <>
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl">Financial Goals</CardTitle>
              <CardDescription>
                Set your initial financial goals to work towards.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-center py-20">Financial Goals Form Component Will Go Here</p>
        ...
        {currentStep === 'tutorial' && (
          <>
            <CardHeader>
              <CardTitle className="text-2xl md:text-3xl">App Tutorial</CardTitle>
              <CardDescription>
                Learn how to use the key features of Stackr.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-center py-20">App Tutorial Component Will Go Here</p>
        ...
        {currentStep === 'complete' && (
          <>
            ...
            <CardContent className="text-center py-10">
              ...
              <h3 className="text-xl font-semibold mb-2">Your financial journey begins now</h3>
              <p className="text-muted-foreground">
                You've completed all the setup steps. You'll be redirected to your dashboard in a moment.
              </p>
            </CardContent>
