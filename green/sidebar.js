    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Gig Resources',
          badge: 'NEW',
          icon: '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v6a2 2 0 0 0 2 2h6"></path><path d="M22 12v7a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7"></path><circle cx="16" cy="19" r="2"></circle><circle cx="8" cy="19" r="2"></circle></svg>'
        }
      ]
    },
    {
